...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#perusahaanTable tbody tr', function(e) {
            ...
            $(document).on('mouseenter', '#perusahaanTable tbody tr', function() {
                $(this).addClass('row-hover-active');
            }).on('mouseleave', '#perusahaanTable tbody tr', function() {
