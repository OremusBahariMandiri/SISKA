            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-map-marker-alt me-2"></i>Manajemen Wilayah Kerja</span>
                                ...
                                <tbody>
                                    @foreach ($wilayahKerjas as $wilayahKerja)
                                        <tr>
                                            ...
                                            <td>{{ $wilayahKerja->GolonganWilker }}</td>
                                            <td>{{ $wilayahKerja->WilayahKerja }}</td>
                                            <td>{{ $wilayahKerja->SingkatanWilker }}</td>
                                            <td>
                                                <div class="d-flex gap-1 justify-content-center">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-danger delete-confirm"
                                                        ...
                                                        data-name="{{ $wilayahKerja->WilayahKerja }}"
                                                        data-bs-toggle="tooltip" title="Hapus">
