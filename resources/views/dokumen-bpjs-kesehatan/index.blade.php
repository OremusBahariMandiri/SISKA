...
@section('title', 'Manajemen Dokumen BPJS Kesehatan')

@section('content')
    <div class="container-fluid dokumenBpjsKesehatanPage">
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-file-medical me-2"></i>Manajemen Dokumen BPJS Kesehatan</span>
                        <div>
                            ...
                            @if (auth()->user()->is_admin || ($userPermissions['tambah'] ?? false))
                                <a href="{{ route('dokumen-bpjs-kesehatan.create') }}" class="btn btn-light">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="dokumenBpjsKesehatanTable" class="table table-bordered table-striped data-table">
                                ...
                                <tbody>
                                    @foreach ($dokumenBpjsKesehatan as $index => $dokumen)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            ...
                                            <td class="text-center">
                                                @if ($dokumen->FileDok)
                                                    <div class="btn-group">
                                                        <a href="{{ route('dokumen-bpjs-kesehatan.viewDocument', $dokumen->id) }}"
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 justify-content-center">
                                                    @if (auth()->user()->is_admin || ($userPermissions['detail'] ?? false))
                                                        <a href="{{ route('dokumen-bpjs-kesehatan.show', $dokumen->id) }}"
                                                    ...
                                                    @if (auth()->user()->is_admin || ($userPermissions['ubah'] ?? false))
                                                        <a href="{{ route('dokumen-bpjs-kesehatan.edit', $dokumen->id) }}"
                                                            class="btn btn-sm text-white" data-bs-toggle="tooltip"
                                                    ...
                                                    {{-- @if (auth()->user()->is_admin || ($userPermissions['download'] ?? false))
                                                        <a href="{{ route('dokumen-bpjs-kesehatan.download', $dokumen->id) }}"
                                                            class="btn btn-sm text-white" data-bs-toggle="tooltip"
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="filterModalLabel">
                        <i class="fas fa-filter me-2"></i>Filter Dokumen BPJS Kesehatan
                    </h5>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" id="filter_karyawan">
                                        ...
                                        @foreach ($dokumenBpjsKesehatan->pluck('karyawan.NamaKry')->unique() as $namaKaryawan)
                                            @if ($namaKaryawan)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" id="filter_kategori">
                                        ...
                                        @foreach ($dokumenBpjsKesehatan->pluck('KategoriDok')->unique() as $kategori)
                                            @if ($kategori)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" id="filter_jenis">
                                        ...
                                        @foreach ($dokumenBpjsKesehatan->pluck('JenisDok')->unique() as $jenis)
                                            @if ($jenis)
    ...
    <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="deleteConfirmationModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus dokumen BPJS Kesehatan dengan nomor registrasi <strong
...
@push('styles')
    ...
    <style>
        ...
        .dokumenBpjsKesehatanPage .dataTables_wrapper .dataTables_length,
        .dokumenBpjsKesehatanPage .dataTables_wrapper .dataTables_filter {
        ...
        .dokumenBpjsKesehatanPage .dataTables_wrapper .dataTables_filter label {
        ...
        .dokumenBpjsKesehatanPage .dataTables_wrapper .dataTables_filter input {
        ...
        .dokumenBpjsKesehatanPage table.dataTable thead th {
            position: relative;
            background-image: none !important;
        }

        .dokumenBpjsKesehatanPage table.dataTable thead th.sorting:after,
        .dokumenBpjsKesehatanPage table.dataTable thead th.sorting_asc:after,
        .dokumenBpjsKesehatanPage table.dataTable thead th.sorting_desc:after {
            position: absolute;
            top: 12px;
            right: 8px;
            display: block;
        ...
        .dokumenBpjsKesehatanPage .btn-sm {
            transition: transform 0.2s;
        }

        .dokumenBpjsKesehatanPage .btn-sm:hover {
            transform: scale(1.1);
        }

        /* Hover effect for table rows */
        .dokumenBpjsKesehatanPage #dokumenBpjsKesehatanTable tbody tr {
            transition: all 0.2s ease;
        }

        .dokumenBpjsKesehatanPage #dokumenBpjsKesehatanTable tbody tr:hover {
        ...
        .dokumenBpjsKesehatanPage #dokumenBpjsKesehatanTable tbody tr.row-hover-active {
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($.fn.dataTable.isDataTable('#dokumenBpjsKesehatanTable')) {
                // Destroy existing instance if it exists
                $('#dokumenBpjsKesehatanTable').DataTable().destroy();
            }
            ...
            var table = $('#dokumenBpjsKesehatanTable').DataTable({
                responsive: true,
            ...
            $(document).on('click', '.delete-confirm', function(e) {
                ...
                // Set form action URL
                $('#deleteForm').attr('action', "{{ url('dokumen-bpjs-kesehatan') }}/" + id);
...
`)
            ...
            $('#dokumenBpjsKesehatanTable tbody').on('click', 'tr', function(e) {
            ...
            $('#dokumenBpjsKesehatanTable tbody').on('mouseenter', 'tr', function() {
