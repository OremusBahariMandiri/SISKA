            ...
            <div class="col-md-10">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('dokumen-karir.edit', $dokumenKarir->Id) }}"
                                        ...
                                        <div class="info-group mb-3">
                                            ...
                                            <div class="info-value">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-control">{{ $dokumenKarir->karyawan->NamaKry ?? '-' }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="info-group mb-3">
                                            ...
                                            <div class="info-value">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-control">{{ $dokumenKarir->jabatan->Jabatan ?? '-' }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="info-value">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-control">
                                                        {{ $dokumenKarir->departemen->Departemen ?? '-' }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="info-group mb-3">
                                            ...
                                            <div class="info-value">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-control">
                                                        {{ $dokumenKarir->wilker->WilayahKerja ?? '-' }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="info-group mb-3">
                                            ...
                                            <div class="info-value">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-control">
                                                        {{ $dokumenKarir->kategori->KategoriDok ?? '-' }}</div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-control">
                                                        @if ($dokumenKarir->TglBerakhirDok)
                                                            <span
                                                                class="{{ now()->gt($dokumenKarir->TglBerakhirDok) ? 'text-danger fw-bold' : '' }}">
