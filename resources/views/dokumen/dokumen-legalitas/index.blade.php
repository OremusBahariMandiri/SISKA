...
@section('title', 'Manajemen Dokumen Legalitas')

@section('content')
    <div class="container-fluid dokumenLegalitasPage">
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-file-alt me-2"></i>Manajemen Dokumen Legalitas</span>
                        <div>
                            ...
                            <a href="{{ route('dokumen-legalitas.create') }}" class="btn btn-light">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="dokumenLegalitasTable" class="table table-bordered table-striped data-table">
                                ...
                                <tbody>
                                    @foreach ($dokumenLegalitas as $index => $dokumen)
                                        <tr data-tgl-pengingat="{{ $dokumen->TglPengingat ? $dokumen->TglPengingat->format('Y-m-d') : '' }}"
                                            ...
                                            <td>
                                                @if ($dokumen->TglBerakhirDok)
                                                    <span
                                                        class="{{ now()->gt($dokumen->TglBerakhirDok) ? 'text-danger fw-bold' : '' }}">
                                                        {{ $dokumen->TglBerakhirDok->format('d/m/Y') }}
                                                        @if (now()->gt($dokumen->TglBerakhirDok))
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="filterModalLabel">
                        <i class="fas fa-filter me-2"></i>Filter Dokumen Legalitas
                    </h5>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="filter_karyawan">
                                        ...
                                        @foreach ($dokumenLegalitas->pluck('karyawan.NamaKry')->unique() as $namaKaryawan)
                                            @if ($namaKaryawan)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="filter_kategori">
                                        ...
                                        @foreach ($dokumenLegalitas->pluck('KategoriDok')->unique() as $kategori)
                                            @if ($kategori)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="filter_jenis">
                                        ...
                                        @foreach ($dokumenLegalitas->pluck('JenisDok')->unique() as $jenis)
                                            @if ($jenis)
    ...
    <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="deleteConfirmationModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus dokumen legalitas dengan nomor registrasi <strong
...
@push('styles')
    ...
    <style>
        ...
        .dokumenLegalitasPage .dataTables_wrapper .dataTables_length,
        .dokumenLegalitasPage .dataTables_wrapper .dataTables_filter {
        ...
        .dokumenLegalitasPage .dataTables_wrapper .dataTables_filter label {
        ...
        .dokumenLegalitasPage .dataTables_wrapper .dataTables_filter input {
        ...
        .dokumenLegalitasPage table.dataTable thead th {
            position: relative;
            background-image: none !important;
        }

        .dokumenLegalitasPage table.dataTable thead th.sorting:after,
        .dokumenLegalitasPage table.dataTable thead th.sorting_asc:after,
        .dokumenLegalitasPage table.dataTable thead th.sorting_desc:after {
            position: absolute;
            top: 12px;
            right: 8px;
            display: block;
        ...
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-red {
        ...
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-yellow {
        ...
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-orange {
        ...
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-gray {
        ...
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-red:hover {
            background-color: #ff3333 !important;
        }

        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-yellow:hover {
            background-color: #ffff66 !important;
        }

        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-orange:hover {
            background-color: #00e013 !important;
        }

        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-gray:hover {
            background-color: #dddddd !important;
        }

        /* Override Bootstrap's striped table styles */
        .dokumenLegalitasPage .table-striped>tbody>tr:nth-of-type(odd).highlight-red,
        .dokumenLegalitasPage .table-striped>tbody>tr:nth-of-type(even).highlight-red {
            background-color: #fc0000 !important;
        }

        .dokumenLegalitasPage .table-striped>tbody>tr:nth-of-type(odd).highlight-yellow,
        .dokumenLegalitasPage .table-striped>tbody>tr:nth-of-type(even).highlight-yellow {
            background-color: #ffff00 !important;
        }

        .dokumenLegalitasPage .table-striped>tbody>tr:nth-of-type(odd).highlight-orange,
        .dokumenLegalitasPage .table-striped>tbody>tr:nth-of-type(even).highlight-orange {
            background-color: #00e013 !important;
        }

        .dokumenLegalitasPage .table-striped>tbody>tr:nth-of-type(odd).highlight-gray,
        .dokumenLegalitasPage .table-striped>tbody>tr:nth-of-type(even).highlight-gray {
            background-color: #cccccc !important;
        }

        /* Memastikan kolom tabel tetap terlihat meskipun dalam baris yang di-highlight */
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-red>td,
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-yellow>td,
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-orange>td,
        .dokumenLegalitasPage table#dokumenLegalitasTable tbody tr.highlight-gray>td {
            background-color: inherit !important;
        }

        /* Add hover effect to action buttons */
        .dokumenLegalitasPage .btn-sm {
            transition: transform 0.2s;
        }

        .dokumenLegalitasPage .btn-sm:hover {
            transform: scale(1.1);
        }

        /* Hover effect for table rows */
        .dokumenLegalitasPage #dokumenLegalitasTable tbody tr {
            transition: all 0.2s ease;
        }

        .dokumenLegalitasPage #dokumenLegalitasTable tbody tr:hover {
        ...
        .dokumenLegalitasPage #dokumenLegalitasTable tbody tr.row-hover-active {
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($.fn.dataTable.isDataTable('#dokumenLegalitasTable')) {
                // Destroy existing instance if it exists
                $('#dokumenLegalitasTable').DataTable().destroy();
            }
            ...
            function updateDocumentStats() {
                ...
                $('#dokumenLegalitasTable tbody tr').removeClass(
                ...
                $('#dokumenLegalitasTable tbody tr').each(function() {
                    const row = $(this);
                    let isExpired = false;
                    let isWarning = false;
            ...
            var table = $('#dokumenLegalitasTable').DataTable({
                responsive: true,
            ...
            $(document).on('click', '.delete-confirm', function(e) {
                ...
                // Set form action URL
                $('#deleteForm').attr('action', "{{ url('dokumen-legalitas') }}/" + id);
    ...
    `)
            ...
            $('#dokumenLegalitasTable tbody').on('click', 'tr', function(e) {
            ...
            // Form untuk export
            $(`
    <form id="exportForm" action="{{ route('dokumen-legalitas.export-excel') }}" method="POST" class="d-none">
    @csrf
    ...
    `).insertAfter('#dokumenLegalitasTable');
            ...
            $('#dokumenLegalitasTable tbody').on('mouseenter', 'tr', function() {
