            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-file-plus me-2"></i>Tambah Dokumen Legalitas</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dokumen-legalitas.store') }}" method="POST" id="dokumenLegalitasForm"
