            ...
            <div class="col-md-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dokumen-bpjs-kesehatan.store') }}" method="POST" id="dokumenBpjsKesehatanForm"
                            ...
                            <ul class="nav nav-tabs mb-4" id="formTabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="info-iuran-tab" data-bs-toggle="tab"
                                        data-bs-target="#info-iuran" type="button" role="tab"
                                        aria-controls="info-iuran" aria-selected="false">
                                        <i class="fas fa-money-bill-wave me-1"></i> Iuran BPJS
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="info-lainnya-tab" data-bs-toggle="tab"
                                        data-bs-target="#info-lainnya" type="button" role="tab"
                                        aria-controls="info-lainnya" aria-selected="false">
                                        <i class="fas fa-info-circle me-1"></i> Informasi Lainnya
                                    </button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="info-karyawan" role="tabpanel"
                                    ...
                                    <div class="card border-secondary mb-4">
                                        <div class="card-header bg-secondary bg-opacity-25 text-dark">
                                            <h5 class="mb-0"><i class="fas fa-info-circle me-2"></i>Informasi Dokumen & Karyawan
                                            </h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                ...
                                <!-- Informasi Iuran BPJS Tab -->
                                <div class="tab-pane fade" id="info-iuran" role="tabpanel"
                                    aria-labelledby="info-iuran-tab">
                                    <div class="card border-secondary mb-4">
                                        <div class="card-header bg-secondary bg-opacity-25 text-dark">
                                            <h5 class="mb-0"><i class="fas fa-money-bill-wave me-2"></i>Informasi Iuran BPJS Kesehatan</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="UpahKtrKry" class="form-label fw-bold">Upah Kotor <span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <span class="input-group-text">Rp</span>
                                                            <input type="text"
                                                                class="form-control currency-input @error('UpahKtrKry') is-invalid @enderror"
                                                                id="UpahKtrKry" name="UpahKtrKry" value="{{ old('UpahKtrKry') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="UpahBrshKry" class="form-label fw-bold">Upah Bersih <span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <span class="input-group-text">Rp</span>
                                                            <input type="text"
                                                                class="form-control currency-input @error('UpahBrshKry') is-invalid @enderror"
                                                                id="UpahBrshKry" name="UpahBrshKry" value="{{ old('UpahBrshKry') }}"
                                                                placeholder="0" required>
                                                            @error('UpahBrshKry')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card border-info mb-3">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group mb-3">
                                                                <label for="IuranPrshPersen" class="form-label fw-bold">Persentase <span
                                                                        class="text-danger">*</span></label>
                                                                <div class="input-group">
                                                                    <input type="number"
                                                                        class="form-control decimal-input @error('IuranPrshPersen') is-invalid @enderror"
                                                                        id="IuranPrshPersen" name="IuranPrshPersen"
                                                                        value="{{ old('IuranPrshPersen') }}"
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        id="IuranPrshRp" name="IuranPrshRp" value="{{ old('IuranPrshRp') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card border-warning mb-3">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group mb-3">
                                                                <label for="IuranKryPersen" class="form-label fw-bold">Persentase <span
                                                                        class="text-danger">*</span></label>
                                                                <div class="input-group">
                                                                    <input type="number"
                                                                        class="form-control decimal-input @error('IuranKryPersen') is-invalid @enderror"
                                                                        id="IuranKryPersen" name="IuranKryPersen"
                                                                        value="{{ old('IuranKryPersen') }}"
                                                                        min="0" max="100" step="0.01" placeholder="0" required>
                                                                    <span class="input-group-text">%</span>
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        id="IuranKryRp" name="IuranKryRp" value="{{ old('IuranKryRp') }}"
                                                                        placeholder="0" readonly required>
                                                                    @error('IuranKryRp')
                                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                                    @enderror
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="IuranKry1Rp" class="form-label fw-bold">Iuran Karyawan 1 (Opsional)</label>
                                                        <div class="input-group">
                                                            <span class="input-group-text">Rp</span>
                                                            <input type="text"
                                                                class="form-control currency-input @error('IuranKry1Rp') is-invalid @enderror"
                                                                id="IuranKry1Rp" name="IuranKry1Rp" value="{{ old('IuranKry1Rp') }}"
                                                                placeholder="0">
                                                            @error('IuranKry1Rp')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="IuranKry2Rp" class="form-label fw-bold">Iuran Karyawan 2 (Opsional)</label>
                                                        <div class="input-group">
                                                            <span class="input-group-text">Rp</span>
                                                            <input type="text"
                                                                class="form-control currency-input @error('IuranKry2Rp') is-invalid @enderror"
                                                                id="IuranKry2Rp" name="IuranKry2Rp" value="{{ old('IuranKry2Rp') }}"
                                                                placeholder="0">
                                                            @error('IuranKry2Rp')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="IuranKry3Rp" class="form-label fw-bold">Iuran Karyawan 3 (Opsional)</label>
                                                        <div class="input-group">
                                                            <span class="input-group-text">Rp</span>
                                                            <input type="text"
                                                                class="form-control currency-input @error('IuranKry3Rp') is-invalid @enderror"
                                                                id="IuranKry3Rp" name="IuranKry3Rp" value="{{ old('IuranKry3Rp') }}"
                                                                placeholder="0">
                                                            @error('IuranKry3Rp')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="JmlPrshRp" class="form-label fw-bold">Jumlah Iuran Perusahaan <span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <span class="input-group-text">Rp</span>
                                                            <input type="text"
                                                                class="form-control currency-input @error('JmlPrshRp') is-invalid @enderror"
                                                                id="JmlPrshRp" name="JmlPrshRp" value="{{ old('JmlPrshRp') }}"
                                                                placeholder="0" readonly required>
                                                            @error('JmlPrshRp')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="JmlKryRp" class="form-label fw-bold">Jumlah Iuran Karyawan <span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <span class="input-group-text">Rp</span>
                                                            <input type="text"
                                                                class="form-control currency-input @error('JmlKryRp') is-invalid @enderror"
                                                                id="JmlKryRp" name="JmlKryRp" value="{{ old('JmlKryRp') }}"
                                                                placeholder="0" readonly required>
                                                            @error('JmlKryRp')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                id="TotIuran" name="TotIuran" value="{{ old('TotIuran') }}"
                                                                placeholder="0" readonly required>
                                                            @error('TotIuran')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                ...
                                <!-- Informasi Lainnya Tab -->
                                <div class="tab-pane fade" id="info-lainnya" role="tabpanel"
                                    aria-labelledby="info-lainnya-tab">
                                    <div class="card border-secondary mb-4">
                                        <div class="card-header bg-secondary bg-opacity-25 text-dark">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const formatCurrency = function(value) {
                ...
                // Handle decimal separator (if any)
                const parts = number.split('.');
                parts[0] = parts[0].replace(/\B(?=(\d{3})+(?!\d))/g, '.');

                // Format with thousand separator and keep up to 2 decimal places
                if (parts.length > 1) {
            ...
            document.querySelectorAll('.decimal-input').forEach(function(input) {
                input.addEventListener('input', function() {
                    // Ensure only numbers and up to 2 decimal places
                    const value = this.value;
            ...
            function calculateAll() {
                ...
                // Calculate iuran perusahaan in rupiah (with 2 decimal precision)
                const iuranPrshRp = (upahBersih * iuranPrshPersen / 100).toFixed(2);
                document.getElementById('IuranPrshRp').value = formatCurrency(iuranPrshRp.toString());

                // Calculate iuran karyawan in rupiah (with 2 decimal precision)
                const iuranKryRp = (upahBersih * iuranKryPersen / 100).toFixed(2);
                ...
                // Calculate totals
                const jmlPrshRp = parseFloat(iuranPrshRp); // Jumlah iuran perusahaan = iuran perusahaan
                const jmlKryRp = parseFloat(iuranKryRp) + iuranKry1Rp + iuranKry2Rp + iuranKry3Rp; // Jumlah iuran karyawan
                const totIuran = jmlPrshRp + jmlKryRp; // Total iuran

                // Update fields with formatted values
                document.getElementById('JmlPrshRp').value = formatCurrency(jmlPrshRp.toFixed(2));
                document.getElementById('JmlKryRp').value = formatCurrency(jmlKryRp.toFixed(2));
                document.getElementById('TotIuran').value = formatCurrency(totIuran.toFixed(2));
            }
            ...
            const tabs = ['info-karyawan', 'info-iuran', 'info-lainnya'];
            ...
            nextTabBtn.addEventListener('click', function() {
                ...
                requiredFields.forEach(field => {
                    if (!field.value) {
                        ...
                        // Handle custom select validation
                        if (field.id === 'IdKodeA04' || field.id === 'KategoriDok' || field.id === 'JenisDok') {
                            const containerId = field.id.replace('IdKode', '').replace('Dok', '') + 'Container';
                            const container = document.getElementById(containerId);
                            if (container) {
                                container.classList.add('is-invalid');
                            }
                ...
                if (isValid && currentTabIndex < tabs.length - 1) {
                    ...
                    requiredFields.forEach(field => {
                        if (!field.value) {
                            const fieldName = field.closest('.form-group')?.querySelector('.form-label')?.textContent.replace('*', '').trim() || 'Field';
                            const li = document.createElement('li');
                            li.textContent = `${fieldName} harus diisi`;
            ...
            submitBtn.addEventListener('click', function(event) {
                ...
                document.querySelectorAll('[required]').forEach(function(input) {
                    if (!input.value) {
                        ...
                        // Handle custom select validation
                        if (input.type === 'hidden' && (input.id.includes('IdKode') || input.id.includes('Dok'))) {
                ...
                if (!fileIsValid) {
                    isValid = false;
                    invalidFieldsList.push('File Dokumen');
                }
                ...
                if (!isValid) {
                    ...
                    invalidFieldsList.forEach(function(field) {
                        const li = document.createElement('li');
                        li.textContent = `${field} harus diisi`;
                        validationMessages.appendChild(li);
                    });
