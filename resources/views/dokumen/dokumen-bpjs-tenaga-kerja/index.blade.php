...
@section('title', 'Manajemen Dokumen BPJS Tenaga Kerja')

@section('content')
    <div class="container-fluid dokumenBpjsTenagaKerjaPage">
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-file-medical me-2"></i>Manajemen Dokumen BPJS Tenaga Kerja</span>
                        <div>
                            ...
                            @if (auth()->user()->is_admin || ($userPermissions['tambah'] ?? false))
                                <a href="{{ route('dokumen-bpjs-tenaga-kerja.create') }}" class="btn btn-light">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="dokumenBpjsTenagaKerjaTable" class="table table-bordered table-striped data-table">
                                ...
                                <tbody>
                                    @foreach ($dokumenBpjsTenagaKerja as $index => $dokumen)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            ...
                                            <td class="text-center">
                                                @if ($dokumen->FileDok)
                                                    <div class="btn-group">
                                                        <a href="{{ route('dokumen-bpjs-tenaga-kerja.viewDocument', $dokumen->id) }}"
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 justify-content-center">
                                                    @if (auth()->user()->is_admin || ($userPermissions['detail'] ?? false))
                                                        <a href="{{ route('dokumen-bpjs-tenaga-kerja.show', $dokumen->id) }}"
                                                    ...
                                                    @if (auth()->user()->is_admin || ($userPermissions['ubah'] ?? false))
                                                        <a href="{{ route('dokumen-bpjs-tenaga-kerja.edit', $dokumen->id) }}"
                                                            class="btn btn-sm text-white" data-bs-toggle="tooltip"
                                                    ...
                                                    {{-- @if (auth()->user()->is_admin || ($userPermissions['download'] ?? false))
                                                        <a href="{{ route('dokumen-bpjs-tenaga-kerja.download', $dokumen->id) }}"
                                                            class="btn btn-sm text-white" data-bs-toggle="tooltip"
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="filterModalLabel">
                        <i class="fas fa-filter me-2"></i>Filter Dokumen BPJS Tenaga Kerja
                    </h5>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" id="filter_karyawan">
                                        ...
                                        @foreach ($dokumenBpjsTenagaKerja->pluck('karyawan.NamaKry')->unique() as $namaKaryawan)
                                            @if ($namaKaryawan)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" id="filter_kategori">
                                        ...
                                        @foreach ($dokumenBpjsTenagaKerja->pluck('KategoriDok')->unique() as $kategori)
                                            @if ($kategori)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" id="filter_jenis">
                                        ...
                                        @foreach ($dokumenBpjsTenagaKerja->pluck('JenisDok')->unique() as $jenis)
                                            @if ($jenis)
    ...
    <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="deleteConfirmationModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus dokumen BPJS Tenaga Kerja dengan nomor registrasi <strong
...
@push('styles')
    ...
    <style>
        ...
        .dokumenBpjsTenagaKerjaPage .dataTables_wrapper .dataTables_length,
        .dokumenBpjsTenagaKerjaPage .dataTables_wrapper .dataTables_filter {
        ...
        .dokumenBpjsTenagaKerjaPage .dataTables_wrapper .dataTables_filter label {
        ...
        .dokumenBpjsTenagaKerjaPage .dataTables_wrapper .dataTables_filter input {
        ...
        .dokumenBpjsTenagaKerjaPage table.dataTable thead th {
            position: relative;
            background-image: none !important;
        }

        .dokumenBpjsTenagaKerjaPage table.dataTable thead th.sorting:after,
        .dokumenBpjsTenagaKerjaPage table.dataTable thead th.sorting_asc:after,
        .dokumenBpjsTenagaKerjaPage table.dataTable thead th.sorting_desc:after {
            position: absolute;
            top: 12px;
            right: 8px;
            display: block;
        ...
        .dokumenBpjsTenagaKerjaPage .btn-sm {
            transition: transform 0.2s;
        }

        .dokumenBpjsTenagaKerjaPage .btn-sm:hover {
            transform: scale(1.1);
        }

        /* Hover effect for table rows */
        .dokumenBpjsTenagaKerjaPage #dokumenBpjsTenagaKerjaTable tbody tr {
            transition: all 0.2s ease;
        }

        .dokumenBpjsTenagaKerjaPage #dokumenBpjsTenagaKerjaTable tbody tr:hover {
        ...
        .dokumenBpjsTenagaKerjaPage #dokumenBpjsTenagaKerjaTable tbody tr.row-hover-active {
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($.fn.dataTable.isDataTable('#dokumenBpjsTenagaKerjaTable')) {
                // Destroy existing instance if it exists
                $('#dokumenBpjsTenagaKerjaTable').DataTable().destroy();
            }
            ...
            var table = $('#dokumenBpjsTenagaKerjaTable').DataTable({
                responsive: true,
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        targets: [3, 7] // Jenis, Total Setoran
                    },
                    {
                        // Prioritas ketiga untuk kolom tanggal
                        responsivePriority: 3,
                        targets: [4, 5] // Tgl Terbit, Tgl Berakhir
                    },
                    {
                        // Prioritas keempat untuk kolom yang tidak terlalu penting
                        responsivePriority: 4,
                        targets: [6, 8, 9, 11] // Upah Kotor, Catatan, File, Aksi
                    },
                    {
            ...
            $('#applyFilter').on('click', function() {
                ...
                if (statusVal) {
                    table.column(10).search(statusVal);
                } else {
            ...
            $('#resetFilter').on('click', function() {
                ...
                $('#filter_karyawan, #filter_kategori, #filter_jenis, #filter_status')
            ...
            $(document).on('click', '.delete-confirm', function(e) {
                ...
                // Set form action URL
                $('#deleteForm').attr('action', "{{ url('dokumen-bpjs-tenaga-kerja') }}/" + id);
...
`)
            ...
            $('#dokumenBpjsTenagaKerjaTable tbody').on('click', 'tr', function(e) {
            ...
            $('#dokumenBpjsTenagaKerjaTable tbody').on('mouseenter', 'tr', function() {
