            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Jenis Dokumen</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('jenis-dokumen.update', $jenisDokumen->id) }}" method="POST" id="jenisForm">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select @error('IdKodeA06') is-invalid @enderror" id="IdKodeA06" name="IdKodeA06" required>
                                                ...
                                                @foreach($kategoriDokumens as $kategori)
                                                    <option value="{{ $kategori->IdKode }}" {{ (old('IdKodeA06', $jenisDokumen->IdKodeA06) == $kategori->IdKode) ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('JenisDok') is-invalid @enderror" id="JenisDok" name="JenisDok"
                                                value="{{ old('JenisDok', $jenisDokumen->JenisDok) }}" required>
                                            @error('JenisDok')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
