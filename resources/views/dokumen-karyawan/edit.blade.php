                                                    ...
                                                    <select class="form-select @error('KategoriDok') is-invalid @enderror"
                                                        ...
                                                        @foreach ($kategoriDokumen as $kategori)
                                                            <option value="{{ $kategori->IdKode }}"
                                                                {{ old('KategoriDok', $dokumenKaryawan->KategoriDok) == $kategori->IdKode ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control @error('KetDok') is-invalid @enderror" id="KetDok" name="KetDok"
                                                        rows="3" placeholder="Masukkan keterangan dokumen">{{ old('KetDok', $dokumenKaryawan->KetDok) }}</textarea>
                                                    @error('KetDok')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="bg-light p-2 rounded">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input validasi-dokumen @error('ValidasiDok') is-invalid @enderror"
                                                            ...
                                                            {{ old('ValidasiDok', $dokumenKaryawan->ValidasiDok) == 'Tetap' ? 'checked' : '' }} required>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control tanggal-input @error('TglTerbitDok') is-invalid @enderror"
                                                                id="TglTerbitDok" name="TglTerbitDok" value="{{ old('TglTerbitDok', $dokumenKaryawan->TglTerbitDok ? $dokumenKaryawan->TglTerbitDok->format('Y-m-d') : '') }}" required>
                                                            @error('TglTerbitDok')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="form-group mb-3 tgl-berakhir-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" class="form-control tanggal-input @error('TglBerakhirDok') is-invalid @enderror"
                                                                id="TglBerakhirDok" name="TglBerakhirDok" value="{{ old('TglBerakhirDok', $dokumenKaryawan->TglBerakhirDok ? $dokumenKaryawan->TglBerakhirDok->format('Y-m-d') : '') }}">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control bg-light" id="MasaBerlaku"
                                                    name="MasaBerlaku" value="{{ old('MasaBerlaku', $dokumenKaryawan->MasaBerlaku) }}" readonly>
                                            ...
                                            <div class="form-group mb-3 tgl-pengingat-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" class="form-control tanggal-input @error('TglPengingat') is-invalid @enderror"
                                                        id="TglPengingat" name="TglPengingat" value="{{ old('TglPengingat', $dokumenKaryawan->TglPengingat ? $dokumenKaryawan->TglPengingat->format('Y-m-d') : '') }}">
                                                    @error('TglPengingat')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control bg-light" id="MasaPengingat"
                                                    name="MasaPengingat" value="{{ old('MasaPengingat', $dokumenKaryawan->MasaPengingat) }}" readonly>
                                                <div class="form-text text-muted">
                                                ...
                                                @if($dokumenKaryawan->FileDok)
                                                    <div class="mt-2">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="text-truncate">{{ $dokumenKaryawan->FileDok }}</span>
                                                ...
                                                <div class="bg-light p-2 rounded">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input @error('StatusDok') is-invalid @enderror"
                                                            ...
                                                            {{ old('StatusDok', $dokumenKaryawan->StatusDok) == 'Berlaku' ? 'checked' : '' }} required>
