                        ...
                        <div class="table-responsive">
                            <table id="dokumenKaryawanTable" class="table table-bordered table-striped data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        data-tgl-pengingat="{{ $dokumen->TglPengingat ? $dokumen->TglPengingat->format('Y-m-d') : '' }}"
                                        ...
                                        <td>
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="{{ route('dokumen-karyawan.show', $dokumen->id) }}"
                                                    class="btn btn-sm text-white" data-bs-toggle="tooltip" title="Detail"
                                                ...
                                                {{-- @if($dokumen->FileDok)
                                                    <a href="{{ route('dokumen-karyawan.download', $dokumen->id) }}"
                                                        class="btn btn-sm text-white" data-bs-toggle="tooltip" title="Download"
    ...
    <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="deleteConfirmationModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus dokumen karyawan dengan nomor registrasi <strong id="dokumenNameToDelete"></strong>?</p>
