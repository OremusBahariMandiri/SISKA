                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('departemen.update', $departemen->id) }}" method="POST" id="departemenForm">
                            ...
                            <div class="card border-secondary mb-4">
                                ...
                                <div class="card-body">
                                    <input type="text" class="form-control" id="IdKode" value="{{ $departemen->IdKode }}" hidden>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="GolonganDep" name="GolonganDep"
                                                value="{{ old('GolonganDep', $departemen->GolonganDep) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="Departemen" name="Departemen"
                                                value="{{ old('Departemen', $departemen->Departemen) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="SingkatanDep" name="SingkatanDep"
                                                value="{{ old('SingkatanDep', $departemen->SingkatanDep) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
