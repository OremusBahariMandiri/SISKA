                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('keluarga-karyawan.store') }}" method="POST" id="keluargaForm">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="card border-secondary mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                                ...
                                                                <div class="custom-select-dropdown" id="karyawanDropdown">
                                                                    ...
                                                                    <div class="custom-select-options">
                                                                        ...
                                                                        @foreach ($karyawans as $karyawan)
                                                                            <div class="custom-select-option" data-value="{{ $karyawan->IdKode }}"
                                                ...
                                                <!-- Rest of the form content as in your original code -->
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                ...
                                                <!-- The rest of your original form fields go here -->
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                ...
                                <!-- Include the rest of your tabs (info-pribadi, info-pendidikan, info-kontak) unchanged -->
                                <!-- Info Pribadi Tab -->
                                <div class="tab-pane fade" id="info-pribadi" role="tabpanel"
                                    aria-labelledby="info-pribadi-tab">
                                    <!-- Your existing content for this tab -->
                                </div>
