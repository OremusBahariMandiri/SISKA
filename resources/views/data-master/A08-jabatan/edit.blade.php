            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Jabatan</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('jabatan.update', $jabatan->id) }}" method="POST" id="jabatanForm">
                            ...
                            <div class="card border-secondary mb-4">
                                ...
                                <div class="card-body">
                                    <input type="text" class="form-control" id="IdKode" value="{{ $jabatan->IdKode }}" hidden>
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="GolonganJbt" name="GolonganJbt"
                                                value="{{ old('GolonganJbt', $jabatan->GolonganJbt) }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="SingkatanJbtn" name="SingkatanJbtn"
                                                value="{{ old('SingkatanJbtn', $jabatan->SingkatanJbtn) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
