            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-map-marker-plus me-2"></i>Tambah Wilayah Kerja</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('wilayah-kerja.store') }}" method="POST" id="wilayahKerjaForm">
                            @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="GolonganWilker" name="GolonganWilker"
                                                value="{{ old('GolonganWilker') }}" required>
                                        </div>
                                        <div class="form-text"><i class="fas fa-info-circle me-1"></i>Contoh: Regional, Cabang, Unit, dll.</div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="WilayahKerja" name="WilayahKerja"
                                                value="{{ old('WilayahKerja') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="SingkatanWilker" name="SingkatanWilker"
                                                value="{{ old('SingkatanWilker') }}" required>
                                        </div>
                                        <div class="form-text"><i class="fas fa-info-circle me-1"></i>Contoh: R1, R2, CAB-JKT, dll.</div>
                                    </div>
                                </div>
                            </div>
