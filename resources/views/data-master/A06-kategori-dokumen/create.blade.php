            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-folder-plus me-2"></i>Tambah Kategori Dokumen</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('kategori-dokumen.store') }}" method="POST" id="kategoriForm">
                            @csrf
                            ...
                            <div class="card border-secondary mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-text"><i class="fas fa-info-circle me-1"></i>Contoh: Dokumen Sistem, Dokumen Operasional, dll.</div>
                                    </div>
                                </div>
                            </div>
