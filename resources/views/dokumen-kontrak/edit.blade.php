                                                ...
                                                <div class="bg-light p-2 rounded">
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            value="Tetap"
                                                            {{ old('ValidasiDok', $dokumenKontrak->ValidasiDok) == 'Tetap' ? 'checked' : '' }}
                                                            required>
                                                    ...
                                                    <div class="form-group mb-3 tgl-berakhir-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ old('TglBerakhirDok', $dokumenKontrak->TglBerakhirDok ? $dokumenKontrak->TglBerakhirDok->format('Y-m-d') : '') }}">
                                            ...
                                            <div class="form-group mb-3 tgl-pengingat-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date"
                                                        ...
                                                        value="{{ old('TglPengingat', $dokumenKontrak->TglPengingat ? $dokumenKontrak->TglPengingat->format('Y-m-d') : '') }}">
                                                    @error('TglPengingat')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <!-- File preview container for new uploads -->
                                                ...
                                                <div class="bg-light p-2 rounded">
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            value="Berlaku"
                                                            {{ old('StatusDok', $dokumenKontrak->StatusDok) == 'Berlaku' ? 'checked' : '' }}
                                                            required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateJenisDokumen(kategoriId) {
                ...
                // Reset jenis value only if we're changing the category
                const currentJenisDokValue = jenisHiddenInput.value;
                if (currentJenisDokValue !== selectedJenisDok) {
